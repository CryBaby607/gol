...
const allQuinielas = [
  {
    ...
    color: { bg: "bg-emerald-100", text: "text-emerald-700", btn: "bg-emerald-600", btnHover: "bg-emerald-700" },
  ...
  },
  {
    ...
    color: { bg: "bg-amber-100", text: "text-amber-700", btn: "bg-amber-500", btnHover: "bg-amber-600" },
    textoBoton: "Unirme a esta quiniela"
  },
  {
    id: 3,
    ...
    color: { bg: "bg-blue-100", text: "text-blue-700", btn: "bg-emerald-600", btnHover: "bg-emerald-700" },
    textoBoton: "Unirme a esta quiniela"
  },
  {
    id: 4,
    ...
    color: { bg: "bg-red-100", text: "text-red-700", btn: "bg-red-600", btnHover: "bg-red-700" },
    textoBoton: "Unirme a esta quiniela"
  },
];
